...
<body>
    ...
    <div class="content">
        ...
        <p>Sehubungan dengan pelaksanaan mata kuliah kerja praktik mahasiswa sesuai dengan kurikulum Program Studi yang
            ...
            dengan ini kami sampaikan mahasiswa berikut ini.</p>
        ...
        <p>Mahasiswa tersebut mengajukan pelaksanaan kerja praktik di instansi Bapak/Ibu. Adapun kerja praktik tersebut
            akan dilaksanakan mulai dari tanggal <strong>{{ $tanggal_mulai }}</strong> s.d
            <strong>{{ $tanggal_selesai }}</strong>. Besar harapan kami pada Bapak/Ibu untuk dapat memberikan kesempatan
            serta membantu memfasilitasi mahasiswa sesuai dengan kondisi yang ada.
        </p>
