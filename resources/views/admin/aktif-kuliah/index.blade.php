                            ...
                            <td>
                                <nobr>
                                    <button class="btn btn-primary btn-edit btn-sm mr-3" title="Detail"
                                        data-toggle="modal" data-target="#modalLihat-{{ $data->id_aktif_kuliah }}">
                            ...
                            <td>
                                <nobr>
                                    <button class="btn btn-primary btn-detail-terima btn-sm mr-3" data-toggle="modal"
                                        data-target="#modalDetailTerima-{{ $data->id_aktif_kuliah }}" title="Detail">
                                    ...
                                    <!-- <button class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#penerbitanSurat-{{ $data->id_aktif_kuliah }}" title="Terbitkan"
                                        type="button">
                                        <i class="fa-solid fa-download"></i>
                                        Terbitkan
                                    </button> -->
                                    <a class="btn btn-primary btn-sm"
                                        href=" {{ route('penerbitan-aktif-kuliah', encrypt($data->id_aktif_kuliah)) }}">
                                        <i class="fa-solid fa-download"></i>
                                        Terbitkan
                                    </a>
