...
<div class="modal fade" id="detailRekomendasi-{{ $id }}" tabindex="-1" aria-labelledby="detailRekomendasi-{{ $id }}"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">

        <form action="{{ route('terima-surat-rekomendasi') }}" class="modal-content" method="post"
