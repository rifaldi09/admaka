...
<div class="modal fade" id="tolakRekomendasi-{{ $id }}" tabindex="-1" aria-labelledby="tolakRekomendasi-{{ $id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">

        <form action="{{ route('tolak-surat-rekomendasi') }}" class="modal-content" method="post" enctype="multipart/form-data"
            id="tolak-form">
            @csrf
