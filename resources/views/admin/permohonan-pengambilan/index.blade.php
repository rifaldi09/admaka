                            ...
                            <td>
                                <nobr>
                                    ...
                                    <button class="btn btn-danger btn-tolak btn-sm" data-toggle="modal"
                                        data-target="#modalTolakData-{{ $pp->id_permohonan }}" title="Tolak">
                                        <i class="fa-solid fa-circle-info"></i> Tolak
                                    </button>
                                    @include('admin.permohonan-pengambilan.modal.tolak-data', [
                                    'id' => $pp->id_permohonan, 'route' =>
                                    'tolak-permohonan'
                                    ])
                                </nobr>
                            </td>
                            ...
                            <td>
                                <nobr>
                                    <button class="btn btn-primary btn-detail-terima btn-sm mr-3" data-toggle="modal"
                                        data-target="#detailModal-{{ $pp->id_permohonan }}" title="Detail">
                                    ...
                                    <a href="{{ route('generate-permohonan', $pp->id_permohonan) }}"
                            ...
                            <td>
                                <nobr>
                                    ...
                                    <button class="btn btn-success btn-sm btn-upload" data-toggle="modal"
                                        data-target="#uploadPermohonanModal-{{ $pp->id_permohonan }}" title="Upload">
