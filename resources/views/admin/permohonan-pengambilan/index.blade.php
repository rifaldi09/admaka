...
@section('content')
    <div class="text-center pt-3">
        <h2>Daftar Permohonan Pengambilan Data Penelitian</h2>
    </div>
    ...
    <div class="mt-3" id="Belum Diterima">
        @include('admin.permohonan-pengambilan.table.belum-diterima')
    </div>
    <div class="mt-3 d-none" id="Diterima">
        @include('admin.permohonan-pengambilan.table.diterima')
    </div>
