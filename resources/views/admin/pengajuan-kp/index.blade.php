                            ...
                            <td>
                                <nobr>
                                    ...
                                    <button class="btn btn-danger btn-tolak btn-sm" data-toggle="modal"
                                        data-target="#modalTolakKp-{{$kp->id_pengajuan}}" title="Tolak">
                                        <i class="fa-solid fa-circle-info"></i> Tolak
                                    </button>
                                    @include('admin.pengajuan-kp.modal.detail-kp', [
                                    'id' => $kp->id_pengajuan,
                                    ])
                                    @include('admin.pengajuan-kp.modal.tolak-kp', ['id' => $kp->id_pengajuan, 'route' =>
                                    'tolak-pengajuan'])
                            ...
                            <td>
                                <nobr>
                                    <button class="btn btn-primary btn-detail-terima btn-sm mr-3" data-toggle="modal"
                                        data-target="#detailModal-{{ $kp->id_pengajuan }}" title="Detail">
                                    ...
                                    <a href="{{ route('generate-pengajuan', $kp->id_pengajuan) }}"
