<div class="modal fade" id="editPermohonanModal-{{ $detail->id_permohonan_magang }}" tabindex="-1" role="dialog" aria-labelledby="editPermohonanModalLabel-{{ $detail->id_permohonan_magang }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="editPermohonanModalLabel-{{ $detail->id_permohonan_magang }}">Ubah Surat</h5>
