<div class="modal fade" id="editPengajuanModal-{{ $detail->id_pengajuan }}" tabindex="-1" role="dialog"
    aria-labelledby="editPengajuanModalLabel-{{ $detail->id_pengajuan }}" aria-hidden="true">
