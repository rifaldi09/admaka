...
<div class="modal fade" id="modalTambahSuratRekomendasi" tabindex="-1" aria-labelledby="modalTambahSuratRekomendasi" aria-hidden="true">
    <div class="modal-dialog modal-lg">

        <form action="{{ route('create-surat-rekomendasi') }}" class="modal-content" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="perihal" required placeholder="Contoh: Untuk menjadi peserta Program Kampus Merdeka"></textarea>
                </div>
                <div class="form-group">
                    <label for="tempat_perihal">Tempat Perihal <small class="text-danger text-sm">*Opsional</small></label>
                    <textarea class="form-control" name="tempat_perihal" placeholder="Contoh: Studi Independen Bersertifikat Tahun 2024 yang diselenggarakan oleh Kemendikbud Ristek"></textarea>
                </div>
