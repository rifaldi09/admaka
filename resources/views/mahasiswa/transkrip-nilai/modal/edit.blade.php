    <div class="modal fade" id="editTranskripModal-{{ $detail->id_transkrip }}" tabindex="-1" role="dialog" aria-labelledby="editTranskripModalLabel-{{ $detail->editTranskrip }}" aria-hidden="true">
