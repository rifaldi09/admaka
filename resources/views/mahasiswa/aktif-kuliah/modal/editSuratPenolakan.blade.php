...
<div class="modal fade" id="modalEdit-{{ $data->id_aktif_kuliah }}" tabindex="-1"
    aria-labelledby="modalEdit-{{ $data->id_aktif_kuliah }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">

        <form action="{{ route('edit-penolakan-surat') }}" class="modal-content" method="post"
            enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Surat Penolakan Aktif Kuliah</h5>
