...
class HomepageController extends Controller
{
    ...
    public function hakAkses(){
        ...
        return view('adminLTE.components.hakAkses',compact('dataMhs','dataDsn'));
    }
    ...
    public function editHakAkses(Request $request)
    {
        ...
        return view('adminLTE.components.editHakAkses', compact('dataUser', 'dataUserAkses', 'menuHakAkses'));
    }
}
